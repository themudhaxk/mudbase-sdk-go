...
// checks if the WalletListWebhooks200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletListWebhooks200Response{}

// WalletListWebhooks200Response struct for WalletListWebhooks200Response
type WalletListWebhooks200Response struct {
...
func NewWalletListWebhooks200Response() *WalletListWebhooks200Response {
	this := WalletListWebhooks200Response{}
	return &this
}
...
func (o WalletListWebhooks200Response) MarshalJSON() ([]byte, error) {
...
func (o WalletListWebhooks200Response) ToMap() (map[string]interface{}, error) {
...
type NullableWalletListWebhooks200Response struct {
	value *WalletListWebhooks200Response
	isSet bool
}

func (v NullableWalletListWebhooks200Response) Get() *WalletListWebhooks200Response {
	return v.value
}

func (v *NullableWalletListWebhooks200Response) Set(val *WalletListWebhooks200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletListWebhooks200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletListWebhooks200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletListWebhooks200Response(val *WalletListWebhooks200Response) *NullableWalletListWebhooks200Response {
	return &NullableWalletListWebhooks200Response{value: val, isSet: true}
}

func (v NullableWalletListWebhooks200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletListWebhooks200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
