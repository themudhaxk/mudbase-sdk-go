...
// checks if the ValidatePasswordResetTokenRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidatePasswordResetTokenRequest{}

// ValidatePasswordResetTokenRequest struct for ValidatePasswordResetTokenRequest
type ValidatePasswordResetTokenRequest struct {
	// Token from the reset link query parameter
	Token string `json:"token"`
}

type _ValidatePasswordResetTokenRequest ValidatePasswordResetTokenRequest
...
func NewValidatePasswordResetTokenRequest(token string) *ValidatePasswordResetTokenRequest {
	this := ValidatePasswordResetTokenRequest{}
	this.Token = token
	return &this
}
...
func (o ValidatePasswordResetTokenRequest) MarshalJSON() ([]byte, error) {
...
func (o ValidatePasswordResetTokenRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["token"] = o.Token
	return toSerialize, nil
}

func (o *ValidatePasswordResetTokenRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varValidatePasswordResetTokenRequest := _ValidatePasswordResetTokenRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varValidatePasswordResetTokenRequest)

	if err != nil {
		return err
	}

	*o = ValidatePasswordResetTokenRequest(varValidatePasswordResetTokenRequest)

	return err
}

type NullableValidatePasswordResetTokenRequest struct {
	value *ValidatePasswordResetTokenRequest
	isSet bool
}

func (v NullableValidatePasswordResetTokenRequest) Get() *ValidatePasswordResetTokenRequest {
	return v.value
}

func (v *NullableValidatePasswordResetTokenRequest) Set(val *ValidatePasswordResetTokenRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableValidatePasswordResetTokenRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableValidatePasswordResetTokenRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidatePasswordResetTokenRequest(val *ValidatePasswordResetTokenRequest) *NullableValidatePasswordResetTokenRequest {
	return &NullableValidatePasswordResetTokenRequest{value: val, isSet: true}
}

func (v NullableValidatePasswordResetTokenRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidatePasswordResetTokenRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
