...
// checks if the GetFeeBalances200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFeeBalances200Response{}

// GetFeeBalances200Response struct for GetFeeBalances200Response
type GetFeeBalances200Response struct {
	Success *bool `json:"success,omitempty"`
	Data []GetFeeBalances200ResponseDataInner `json:"data,omitempty"`
}
...
func NewGetFeeBalances200Response() *GetFeeBalances200Response {
	this := GetFeeBalances200Response{}
	return &this
}
...
func (o *GetFeeBalances200Response) GetData() []GetFeeBalances200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetFeeBalances200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetFeeBalances200ResponseDataInner and assigns it to the Data field.
func (o *GetFeeBalances200Response) SetData(v []GetFeeBalances200ResponseDataInner) {
	o.Data = v
}

func (o GetFeeBalances200Response) MarshalJSON() ([]byte, error) {
...
func (o GetFeeBalances200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetFeeBalances200Response struct {
	value *GetFeeBalances200Response
	isSet bool
}

func (v NullableGetFeeBalances200Response) Get() *GetFeeBalances200Response {
	return v.value
}

func (v *NullableGetFeeBalances200Response) Set(val *GetFeeBalances200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFeeBalances200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFeeBalances200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFeeBalances200Response(val *GetFeeBalances200Response) *NullableGetFeeBalances200Response {
	return &NullableGetFeeBalances200Response{value: val, isSet: true}
}

func (v NullableGetFeeBalances200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFeeBalances200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
