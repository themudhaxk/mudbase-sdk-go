...
// checks if the WalletGetCancelParams200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGetCancelParams200ResponseData{}

// WalletGetCancelParams200ResponseData struct for WalletGetCancelParams200ResponseData
type WalletGetCancelParams200ResponseData struct {
...
func NewWalletGetCancelParams200ResponseData() *WalletGetCancelParams200ResponseData {
	this := WalletGetCancelParams200ResponseData{}
	return &this
}
...
func (o WalletGetCancelParams200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o WalletGetCancelParams200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGetCancelParams200ResponseData struct {
	value *WalletGetCancelParams200ResponseData
	isSet bool
}

func (v NullableWalletGetCancelParams200ResponseData) Get() *WalletGetCancelParams200ResponseData {
	return v.value
}

func (v *NullableWalletGetCancelParams200ResponseData) Set(val *WalletGetCancelParams200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGetCancelParams200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGetCancelParams200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGetCancelParams200ResponseData(val *WalletGetCancelParams200ResponseData) *NullableWalletGetCancelParams200ResponseData {
	return &NullableWalletGetCancelParams200ResponseData{value: val, isSet: true}
}

func (v NullableWalletGetCancelParams200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGetCancelParams200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
