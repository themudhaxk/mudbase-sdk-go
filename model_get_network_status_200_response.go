...
// checks if the GetNetworkStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkStatus200Response{}

// GetNetworkStatus200Response struct for GetNetworkStatus200Response
type GetNetworkStatus200Response struct {
	Success *bool `json:"success,omitempty"`
	Data *map[string]GetNetworkStatus200ResponseDataValue `json:"data,omitempty"`
}
...
func NewGetNetworkStatus200Response() *GetNetworkStatus200Response {
	this := GetNetworkStatus200Response{}
	return &this
}
...
func (o *GetNetworkStatus200Response) GetData() map[string]GetNetworkStatus200ResponseDataValue {
	if o == nil || IsNil(o.Data) {
		var ret map[string]GetNetworkStatus200ResponseDataValue
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given map[string]GetNetworkStatus200ResponseDataValue and assigns it to the Data field.
func (o *GetNetworkStatus200Response) SetData(v map[string]GetNetworkStatus200ResponseDataValue) {
	o.Data = &v
}

func (o GetNetworkStatus200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkStatus200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkStatus200Response struct {
	value *GetNetworkStatus200Response
	isSet bool
}

func (v NullableGetNetworkStatus200Response) Get() *GetNetworkStatus200Response {
	return v.value
}

func (v *NullableGetNetworkStatus200Response) Set(val *GetNetworkStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkStatus200Response(val *GetNetworkStatus200Response) *NullableGetNetworkStatus200Response {
	return &NullableGetNetworkStatus200Response{value: val, isSet: true}
}

func (v NullableGetNetworkStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
