...
// checks if the RemoveReaction200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveReaction200Response{}

// RemoveReaction200Response struct for RemoveReaction200Response
type RemoveReaction200Response struct {
	Success *bool `json:"success,omitempty"`
	Data []RemoveReaction200ResponseDataInner `json:"data,omitempty"`
}
...
func NewRemoveReaction200Response() *RemoveReaction200Response {
	this := RemoveReaction200Response{}
	return &this
}
...
func (o *RemoveReaction200Response) GetData() []RemoveReaction200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []RemoveReaction200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []RemoveReaction200ResponseDataInner and assigns it to the Data field.
func (o *RemoveReaction200Response) SetData(v []RemoveReaction200ResponseDataInner) {
	o.Data = v
}

func (o RemoveReaction200Response) MarshalJSON() ([]byte, error) {
...
func (o RemoveReaction200Response) ToMap() (map[string]interface{}, error) {
...
type NullableRemoveReaction200Response struct {
	value *RemoveReaction200Response
	isSet bool
}

func (v NullableRemoveReaction200Response) Get() *RemoveReaction200Response {
	return v.value
}

func (v *NullableRemoveReaction200Response) Set(val *RemoveReaction200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRemoveReaction200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRemoveReaction200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRemoveReaction200Response(val *RemoveReaction200Response) *NullableRemoveReaction200Response {
	return &NullableRemoveReaction200Response{value: val, isSet: true}
}

func (v NullableRemoveReaction200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRemoveReaction200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
