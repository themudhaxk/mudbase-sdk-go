...
// checks if the GetChatDetails200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetChatDetails200Response{}

// GetChatDetails200Response struct for GetChatDetails200Response
type GetChatDetails200Response struct {
	Success *bool `json:"success,omitempty"`
	Data *GetChatDetails200ResponseData `json:"data,omitempty"`
}
...
func NewGetChatDetails200Response() *GetChatDetails200Response {
	this := GetChatDetails200Response{}
	return &this
}
...
func (o *GetChatDetails200Response) GetData() GetChatDetails200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetChatDetails200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GetChatDetails200ResponseData and assigns it to the Data field.
func (o *GetChatDetails200Response) SetData(v GetChatDetails200ResponseData) {
	o.Data = &v
}

func (o GetChatDetails200Response) MarshalJSON() ([]byte, error) {
...
func (o GetChatDetails200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetChatDetails200Response struct {
	value *GetChatDetails200Response
	isSet bool
}

func (v NullableGetChatDetails200Response) Get() *GetChatDetails200Response {
	return v.value
}

func (v *NullableGetChatDetails200Response) Set(val *GetChatDetails200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetChatDetails200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetChatDetails200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetChatDetails200Response(val *GetChatDetails200Response) *NullableGetChatDetails200Response {
	return &NullableGetChatDetails200Response{value: val, isSet: true}
}

func (v NullableGetChatDetails200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetChatDetails200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
