...
// checks if the ProjectUsageSummaryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectUsageSummaryResponse{}

// ProjectUsageSummaryResponse struct for ProjectUsageSummaryResponse
type ProjectUsageSummaryResponse struct {
	Success *bool `json:"success,omitempty"`
	// Contains requests, activeUsers, requestVolume14d, latency, platformUptimePct30d, platformUptimeSamples
...
func NewProjectUsageSummaryResponse() *ProjectUsageSummaryResponse {
	this := ProjectUsageSummaryResponse{}
	return &this
}
...
func (o ProjectUsageSummaryResponse) MarshalJSON() ([]byte, error) {
...
func (o ProjectUsageSummaryResponse) ToMap() (map[string]interface{}, error) {
...
type NullableProjectUsageSummaryResponse struct {
	value *ProjectUsageSummaryResponse
	isSet bool
}

func (v NullableProjectUsageSummaryResponse) Get() *ProjectUsageSummaryResponse {
	return v.value
}

func (v *NullableProjectUsageSummaryResponse) Set(val *ProjectUsageSummaryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectUsageSummaryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectUsageSummaryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectUsageSummaryResponse(val *ProjectUsageSummaryResponse) *NullableProjectUsageSummaryResponse {
	return &NullableProjectUsageSummaryResponse{value: val, isSet: true}
}

func (v NullableProjectUsageSummaryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectUsageSummaryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
