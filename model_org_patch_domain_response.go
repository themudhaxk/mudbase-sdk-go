...
// checks if the OrgPatchDomainResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgPatchDomainResponse{}

// OrgPatchDomainResponse struct for OrgPatchDomainResponse
type OrgPatchDomainResponse struct {
...
type _OrgPatchDomainResponse OrgPatchDomainResponse
...
func (o OrgPatchDomainResponse) MarshalJSON() ([]byte, error) {
...
func (o OrgPatchDomainResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OrgPatchDomainResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varOrgPatchDomainResponse := _OrgPatchDomainResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrgPatchDomainResponse)

	if err != nil {
		return err
	}

	*o = OrgPatchDomainResponse(varOrgPatchDomainResponse)

	return err
}

type NullableOrgPatchDomainResponse struct {
	value *OrgPatchDomainResponse
	isSet bool
}

func (v NullableOrgPatchDomainResponse) Get() *OrgPatchDomainResponse {
	return v.value
}

func (v *NullableOrgPatchDomainResponse) Set(val *OrgPatchDomainResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgPatchDomainResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgPatchDomainResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgPatchDomainResponse(val *OrgPatchDomainResponse) *NullableOrgPatchDomainResponse {
	return &NullableOrgPatchDomainResponse{value: val, isSet: true}
}

func (v NullableOrgPatchDomainResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgPatchDomainResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
