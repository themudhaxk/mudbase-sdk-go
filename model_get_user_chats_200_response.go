...
// checks if the GetUserChats200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUserChats200Response{}

// GetUserChats200Response struct for GetUserChats200Response
type GetUserChats200Response struct {
	Success *bool `json:"success,omitempty"`
	Data *GetUserChats200ResponseData `json:"data,omitempty"`
}
...
func (o *GetUserChats200Response) GetData() GetUserChats200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret GetUserChats200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given GetUserChats200ResponseData and assigns it to the Data field.
func (o *GetUserChats200Response) SetData(v GetUserChats200ResponseData) {
	o.Data = &v
}

func (o GetUserChats200Response) MarshalJSON() ([]byte, error) {
...
func (o GetUserChats200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetUserChats200Response struct {
	value *GetUserChats200Response
	isSet bool
}

func (v NullableGetUserChats200Response) Get() *GetUserChats200Response {
	return v.value
}

func (v *NullableGetUserChats200Response) Set(val *GetUserChats200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUserChats200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUserChats200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUserChats200Response(val *GetUserChats200Response) *NullableGetUserChats200Response {
	return &NullableGetUserChats200Response{value: val, isSet: true}
}

func (v NullableGetUserChats200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUserChats200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
