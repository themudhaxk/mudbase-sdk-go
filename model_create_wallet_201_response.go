...
// checks if the CreateWallet201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWallet201Response{}

// CreateWallet201Response struct for CreateWallet201Response
type CreateWallet201Response struct {
...
func (o CreateWallet201Response) MarshalJSON() ([]byte, error) {
...
func (o CreateWallet201Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateWallet201Response struct {
	value *CreateWallet201Response
	isSet bool
}

func (v NullableCreateWallet201Response) Get() *CreateWallet201Response {
	return v.value
}

func (v *NullableCreateWallet201Response) Set(val *CreateWallet201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWallet201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWallet201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWallet201Response(val *CreateWallet201Response) *NullableCreateWallet201Response {
	return &NullableCreateWallet201Response{value: val, isSet: true}
}

func (v NullableCreateWallet201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateWallet201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
