...
// checks if the CreateCheckoutSession200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCheckoutSession200Response{}
...
type CreateCheckoutSession200Response struct {
	...
	Data *CreateCheckoutSession200ResponseData `json:"data,omitempty"`
}
...
func NewCreateCheckoutSession200Response() *CreateCheckoutSession200Response {
	this := CreateCheckoutSession200Response{}
	return &this
}
...
func (o *CreateCheckoutSession200Response) GetData() CreateCheckoutSession200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret CreateCheckoutSession200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given CreateCheckoutSession200ResponseData and assigns it to the Data field.
...
type NullableCreateCheckoutSession200Response struct {
	value *CreateCheckoutSession200Response
	isSet bool
}

func (v NullableCreateCheckoutSession200Response) Get() *CreateCheckoutSession200Response {
	return v.value
}

func (v *NullableCreateCheckoutSession200Response) Set(val *CreateCheckoutSession200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCheckoutSession200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCheckoutSession200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCheckoutSession200Response(val *CreateCheckoutSession200Response) *NullableCreateCheckoutSession200Response {
	return &NullableCreateCheckoutSession200Response{value: val, isSet: true}
}

func (v NullableCreateCheckoutSession200Response) MarshalJSON() ([]byte, error) {
