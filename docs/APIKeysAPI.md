...
func main() {
	createApiKeyRequest := *models.NewCreateApiKeyRequest("Name_example", "ProjectId_example") // CreateApiKeyRequest | 
...
func main() {
	id := "id_example" // string | 
	updateApiKeyRequest := *models.NewUpdateApiKeyRequest() // UpdateApiKeyRequest | 
