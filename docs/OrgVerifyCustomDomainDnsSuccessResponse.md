...
`func (o *OrgVerifyCustomDomainDnsSuccessResponse) GetEdge() OrgEdgeHints`

GetEdge returns the Edge field if non-nil, zero value otherwise.

### GetEdgeOk

`func (o *OrgVerifyCustomDomainDnsSuccessResponse) GetEdgeOk() (*OrgEdgeHints, bool)`
...
`func (o *OrgVerifyCustomDomainDnsSuccessResponse) SetEdge(v OrgEdgeHints)`

SetEdge sets Edge field to given value.

### HasEdge

`func (o *OrgVerifyCustomDomainDnsSuccessResponse) HasEdge() bool`
