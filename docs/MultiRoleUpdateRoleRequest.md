...
**CollectionPermissions** | Pointer to [**map[string]MultiRoleUpdateRoleRequestCollectionPermissionsValue**](MultiRoleUpdateRoleRequestCollectionPermissionsValue.md) | Per-collection CRUD map (same as POST add role). | [optional] 
