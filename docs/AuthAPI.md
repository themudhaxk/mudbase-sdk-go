...
func main() {
	authResendVerificationRequest := *openapiclient.NewAuthResendVerificationRequest("Email_example") // AuthResendVerificationRequest | 
...
func main() {
	authVerifyEmailRequest := *openapiclient.NewAuthVerifyEmailRequest("Token_example") // AuthVerifyEmailRequest | 
