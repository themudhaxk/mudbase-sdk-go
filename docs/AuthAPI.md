...
> MessageResponse AuthResendVerification(ctx).AuthResendVerificationRequest(authResendVerificationRequest).Execute()
...
func main() {
	authResendVerificationRequest := *openapiclient.NewAuthResendVerificationRequest("Email_example") // AuthResendVerificationRequest | Email address to resend to; optional `projectId` for project-scoped verification links.

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AuthAPI.AuthResendVerification(context.Background()).AuthResendVerificationRequest(authResendVerificationRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AuthAPI.AuthResendVerification``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AuthResendVerification`: MessageResponse
...
> MessageResponse AuthVerifyEmail(ctx).AuthVerifyEmailRequest(authVerifyEmailRequest).Execute()
...
func main() {
	authVerifyEmailRequest := *openapiclient.NewAuthVerifyEmailRequest("Token_example") // AuthVerifyEmailRequest | Verification token from the email link; optional `projectId` for project-scoped signup.

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AuthAPI.AuthVerifyEmail(context.Background()).AuthVerifyEmailRequest(authVerifyEmailRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AuthAPI.AuthVerifyEmail``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AuthVerifyEmail`: MessageResponse
	fmt.Fprintf(os.Stdout, "Response from `AuthAPI.AuthVerifyEmail`: %v\n", resp)
}
```
