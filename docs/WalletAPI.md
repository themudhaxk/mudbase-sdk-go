...
> WalletTestWebhook200Response WalletTestWebhook(ctx).WalletTestWebhookRequest(walletTestWebhookRequest).Execute()
...
func main() {
	...
	// response from `WalletTestWebhook`: WalletTestWebhook200Response
