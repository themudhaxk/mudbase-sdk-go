...
**RoutingCnameTarget** | Pointer to **NullableString** | Routing CNAME target: the managed certificate&#39;s provisioned CNAME target when requirements have been stored; otherwise the platform default target. | [optional] 
...
**FlyCertificateStatus** | Pointer to **NullableString** | Managed certificate &#x60;status&#x60; during provisioning (e.g. &#x60;pending_validation&#x60;, &#x60;active&#x60;). Null when managed certificate provisioning is not in use for this deployment. | [optional] 
...
`func (o *OrgDomainEntryWithDns) GetEdge() OrgEdgeHints`

GetEdge returns the Edge field if non-nil, zero value otherwise.

### GetEdgeOk

`func (o *OrgDomainEntryWithDns) GetEdgeOk() (*OrgEdgeHints, bool)`
...
`func (o *OrgDomainEntryWithDns) SetEdge(v OrgEdgeHints)`

SetEdge sets Edge field to given value.

### HasEdge

`func (o *OrgDomainEntryWithDns) HasEdge() bool`
