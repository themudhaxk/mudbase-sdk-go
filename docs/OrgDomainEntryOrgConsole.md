...
`func (o *OrgDomainEntryOrgConsole) GetEdge() OrgEdgeHints`

GetEdge returns the Edge field if non-nil, zero value otherwise.

### GetEdgeOk

`func (o *OrgDomainEntryOrgConsole) GetEdgeOk() (*OrgEdgeHints, bool)`
...
`func (o *OrgDomainEntryOrgConsole) SetEdge(v OrgEdgeHints)`

SetEdge sets Edge field to given value.

### HasEdge

`func (o *OrgDomainEntryOrgConsole) HasEdge() bool`
