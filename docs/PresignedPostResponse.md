...
------------ | ------------- | ------------- | -------------
**Key** | Pointer to **string** | Object key clients should upload to | [optional] 
**Url** | Pointer to **string** | Presigned URL to PUT the file body to directly | [optional] 
**Method** | Pointer to **string** | HTTP method the client must use against &#x60;url&#x60; (always PUT - the object storage backend does not implement a POST-based upload API) | [optional] 
