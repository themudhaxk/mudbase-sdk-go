...
> MultiRoleGetPermissionsMatrix200Response IntegrationsExecute(ctx, projectId, integrationId).IntegrationsExecuteRequest(integrationsExecuteRequest).Execute()
...
func main() {
	...
	// response from `IntegrationsExecute`: MultiRoleGetPermissionsMatrix200Response
