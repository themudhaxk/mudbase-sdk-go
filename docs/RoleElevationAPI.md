...
func main() {
	projectId := "projectId_example" // string | Project ID.
	roleElevationRequestRequest := *openapiclient.NewRoleElevationRequestRequest("vendor") // RoleElevationRequestRequest | Role slug to request elevation to (e.g. vendor).
