...
func main() {
	projectId := "685ad30be129932fbb7a1047" // string | Project ID.
	multiRoleUpdateSettingsRequest := *openapiclient.NewMultiRoleUpdateSettingsRequest() // MultiRoleUpdateSettingsRequest | Feature flags only — not per-role approval. Use `settings.allowMultipleRoles`, `requireRoleSelection`, `autoAssignDefault`.
