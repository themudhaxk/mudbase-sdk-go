...
func main() {
	projectId := "projectId_example" // string | Project ID.
	chatPutChatE2eeKeyRequest := *openapiclient.NewChatPutChatE2eeKeyRequest("IdentityPublicKey_example") // ChatPutChatE2eeKeyRequest | Identity public key material for E2EE chat (base64). Private keys stay on the client.
