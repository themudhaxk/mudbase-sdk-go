...
// checks if the AddReaction200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddReaction200Response{}

// AddReaction200Response struct for AddReaction200Response
type AddReaction200Response struct {
	Success *bool `json:"success,omitempty"`
	Data []AddReaction200ResponseDataInner `json:"data,omitempty"`
}
...
func (o *AddReaction200Response) GetData() []AddReaction200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []AddReaction200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AddReaction200ResponseDataInner and assigns it to the Data field.
func (o *AddReaction200Response) SetData(v []AddReaction200ResponseDataInner) {
	o.Data = v
}

func (o AddReaction200Response) MarshalJSON() ([]byte, error) {
...
func (o AddReaction200Response) ToMap() (map[string]interface{}, error) {
...
type NullableAddReaction200Response struct {
	value *AddReaction200Response
	isSet bool
}

func (v NullableAddReaction200Response) Get() *AddReaction200Response {
	return v.value
}

func (v *NullableAddReaction200Response) Set(val *AddReaction200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddReaction200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddReaction200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddReaction200Response(val *AddReaction200Response) *NullableAddReaction200Response {
	return &NullableAddReaction200Response{value: val, isSet: true}
}

func (v NullableAddReaction200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddReaction200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
