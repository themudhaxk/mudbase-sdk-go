...
// checks if the BucketListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BucketListResponse{}

// BucketListResponse Paginated list of buckets.
...
func (o BucketListResponse) MarshalJSON() ([]byte, error) {
...
func (o BucketListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBucketListResponse struct {
	value *BucketListResponse
	isSet bool
}

func (v NullableBucketListResponse) Get() *BucketListResponse {
	return v.value
}

func (v *NullableBucketListResponse) Set(val *BucketListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBucketListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBucketListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBucketListResponse(val *BucketListResponse) *NullableBucketListResponse {
	return &NullableBucketListResponse{value: val, isSet: true}
}

func (v NullableBucketListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBucketListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
