...
// checks if the ConfigureWebhook200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigureWebhook200Response{}

// ConfigureWebhook200Response struct for ConfigureWebhook200Response
type ConfigureWebhook200Response struct {
	Success *bool `json:"success,omitempty"`
	Message *string `json:"message,omitempty"`
	Data *ConfigureWebhook200ResponseData `json:"data,omitempty"`
}
...
func NewConfigureWebhook200Response() *ConfigureWebhook200Response {
	this := ConfigureWebhook200Response{}
	return &this
}
...
func (o *ConfigureWebhook200Response) GetData() ConfigureWebhook200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret ConfigureWebhook200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ConfigureWebhook200ResponseData and assigns it to the Data field.
func (o *ConfigureWebhook200Response) SetData(v ConfigureWebhook200ResponseData) {
	o.Data = &v
}

func (o ConfigureWebhook200Response) MarshalJSON() ([]byte, error) {
...
func (o ConfigureWebhook200Response) ToMap() (map[string]interface{}, error) {
...
type NullableConfigureWebhook200Response struct {
	value *ConfigureWebhook200Response
	isSet bool
}

func (v NullableConfigureWebhook200Response) Get() *ConfigureWebhook200Response {
	return v.value
}

func (v *NullableConfigureWebhook200Response) Set(val *ConfigureWebhook200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigureWebhook200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigureWebhook200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigureWebhook200Response(val *ConfigureWebhook200Response) *NullableConfigureWebhook200Response {
	return &NullableConfigureWebhook200Response{value: val, isSet: true}
}

func (v NullableConfigureWebhook200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigureWebhook200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
