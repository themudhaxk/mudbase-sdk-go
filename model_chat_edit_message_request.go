...
type ChatEditMessageRequest struct {
	...
	E2ee *ChatEditMessageRequestE2ee `json:"e2ee,omitempty"`
}
...
func (o *ChatEditMessageRequest) GetE2ee() ChatEditMessageRequestE2ee {
	if o == nil || IsNil(o.E2ee) {
		var ret ChatEditMessageRequestE2ee
		return ret
	}
	return *o.E2ee
}
...
// SetE2ee gets a reference to the given ChatEditMessageRequestE2ee and assigns it to the E2ee field.
