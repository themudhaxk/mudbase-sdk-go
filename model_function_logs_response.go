...
// checks if the FunctionLogsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FunctionLogsResponse{}

// FunctionLogsResponse Paginated function execution logs and stats.
type FunctionLogsResponse struct {
	Success *bool `json:"success,omitempty"`
	Data *FunctionLogsResponseData `json:"data,omitempty"`
}
...
func (o *FunctionLogsResponse) GetData() FunctionLogsResponseData {
	if o == nil || IsNil(o.Data) {
		var ret FunctionLogsResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given FunctionLogsResponseData and assigns it to the Data field.
func (o *FunctionLogsResponse) SetData(v FunctionLogsResponseData) {
	o.Data = &v
}

func (o FunctionLogsResponse) MarshalJSON() ([]byte, error) {
...
func (o FunctionLogsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFunctionLogsResponse struct {
	value *FunctionLogsResponse
	isSet bool
}

func (v NullableFunctionLogsResponse) Get() *FunctionLogsResponse {
	return v.value
}

func (v *NullableFunctionLogsResponse) Set(val *FunctionLogsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFunctionLogsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFunctionLogsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunctionLogsResponse(val *FunctionLogsResponse) *NullableFunctionLogsResponse {
	return &NullableFunctionLogsResponse{value: val, isSet: true}
}

func (v NullableFunctionLogsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFunctionLogsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
