...
type ChatSendMessageRequest struct {
	...
	E2ee *ChatSendMessageRequestE2ee `json:"e2ee,omitempty"`
...
func (o *ChatSendMessageRequest) GetE2ee() ChatSendMessageRequestE2ee {
	if o == nil || IsNil(o.E2ee) {
		var ret ChatSendMessageRequestE2ee
		return ret
	}
	return *o.E2ee
}
...
// SetE2ee gets a reference to the given ChatSendMessageRequestE2ee and assigns it to the E2ee field.
