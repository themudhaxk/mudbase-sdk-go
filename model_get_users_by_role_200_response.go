...
// checks if the GetUsersByRole200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetUsersByRole200Response{}

// GetUsersByRole200Response struct for GetUsersByRole200Response
type GetUsersByRole200Response struct {
...
func NewGetUsersByRole200Response() *GetUsersByRole200Response {
	this := GetUsersByRole200Response{}
	return &this
}
...
func (o GetUsersByRole200Response) MarshalJSON() ([]byte, error) {
...
func (o GetUsersByRole200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetUsersByRole200Response struct {
	value *GetUsersByRole200Response
	isSet bool
}

func (v NullableGetUsersByRole200Response) Get() *GetUsersByRole200Response {
	return v.value
}

func (v *NullableGetUsersByRole200Response) Set(val *GetUsersByRole200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetUsersByRole200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetUsersByRole200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetUsersByRole200Response(val *GetUsersByRole200Response) *NullableGetUsersByRole200Response {
	return &NullableGetUsersByRole200Response{value: val, isSet: true}
}

func (v NullableGetUsersByRole200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetUsersByRole200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
