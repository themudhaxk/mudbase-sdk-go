...
// checks if the InitializePayment200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InitializePayment200Response{}

// InitializePayment200Response struct for InitializePayment200Response
type InitializePayment200Response struct {
	Success *bool `json:"success,omitempty"`
	Data *InitializePayment200ResponseData `json:"data,omitempty"`
}
...
func NewInitializePayment200Response() *InitializePayment200Response {
	this := InitializePayment200Response{}
	return &this
}
...
func (o *InitializePayment200Response) GetData() InitializePayment200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret InitializePayment200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given InitializePayment200ResponseData and assigns it to the Data field.
func (o *InitializePayment200Response) SetData(v InitializePayment200ResponseData) {
	o.Data = &v
}

func (o InitializePayment200Response) MarshalJSON() ([]byte, error) {
...
func (o InitializePayment200Response) ToMap() (map[string]interface{}, error) {
...
type NullableInitializePayment200Response struct {
	value *InitializePayment200Response
	isSet bool
}

func (v NullableInitializePayment200Response) Get() *InitializePayment200Response {
	return v.value
}

func (v *NullableInitializePayment200Response) Set(val *InitializePayment200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInitializePayment200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInitializePayment200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInitializePayment200Response(val *InitializePayment200Response) *NullableInitializePayment200Response {
	return &NullableInitializePayment200Response{value: val, isSet: true}
}

func (v NullableInitializePayment200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInitializePayment200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
