...
// checks if the ListNonCustodialAddresses200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListNonCustodialAddresses200Response{}

// ListNonCustodialAddresses200Response struct for ListNonCustodialAddresses200Response
type ListNonCustodialAddresses200Response struct {
...
func NewListNonCustodialAddresses200Response() *ListNonCustodialAddresses200Response {
	this := ListNonCustodialAddresses200Response{}
	return &this
}
...
func (o ListNonCustodialAddresses200Response) MarshalJSON() ([]byte, error) {
...
func (o ListNonCustodialAddresses200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListNonCustodialAddresses200Response struct {
	value *ListNonCustodialAddresses200Response
	isSet bool
}

func (v NullableListNonCustodialAddresses200Response) Get() *ListNonCustodialAddresses200Response {
	return v.value
}

func (v *NullableListNonCustodialAddresses200Response) Set(val *ListNonCustodialAddresses200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListNonCustodialAddresses200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListNonCustodialAddresses200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListNonCustodialAddresses200Response(val *ListNonCustodialAddresses200Response) *NullableListNonCustodialAddresses200Response {
	return &NullableListNonCustodialAddresses200Response{value: val, isSet: true}
}

func (v NullableListNonCustodialAddresses200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListNonCustodialAddresses200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
