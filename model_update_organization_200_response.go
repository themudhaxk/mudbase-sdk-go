...
// checks if the UpdateOrganization200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateOrganization200Response{}

// UpdateOrganization200Response struct for UpdateOrganization200Response
...
func NewUpdateOrganization200Response() *UpdateOrganization200Response {
	this := UpdateOrganization200Response{}
	return &this
}
...
func (o UpdateOrganization200Response) MarshalJSON() ([]byte, error) {
...
func (o UpdateOrganization200Response) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateOrganization200Response struct {
	value *UpdateOrganization200Response
	isSet bool
}

func (v NullableUpdateOrganization200Response) Get() *UpdateOrganization200Response {
	return v.value
}

func (v *NullableUpdateOrganization200Response) Set(val *UpdateOrganization200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOrganization200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOrganization200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOrganization200Response(val *UpdateOrganization200Response) *NullableUpdateOrganization200Response {
	return &NullableUpdateOrganization200Response{value: val, isSet: true}
}

func (v NullableUpdateOrganization200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateOrganization200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
