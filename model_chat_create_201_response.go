...
// checks if the ChatCreate201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChatCreate201Response{}

// ChatCreate201Response struct for ChatCreate201Response
type ChatCreate201Response struct {
	Success *bool `json:"success,omitempty"`
	Data *ChatCreate201ResponseData `json:"data,omitempty"`
}
...
func (o *ChatCreate201Response) GetData() ChatCreate201ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret ChatCreate201ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ChatCreate201ResponseData and assigns it to the Data field.
func (o *ChatCreate201Response) SetData(v ChatCreate201ResponseData) {
	o.Data = &v
}

func (o ChatCreate201Response) MarshalJSON() ([]byte, error) {
...
func (o ChatCreate201Response) ToMap() (map[string]interface{}, error) {
...
type NullableChatCreate201Response struct {
	value *ChatCreate201Response
	isSet bool
}

func (v NullableChatCreate201Response) Get() *ChatCreate201Response {
	return v.value
}

func (v *NullableChatCreate201Response) Set(val *ChatCreate201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableChatCreate201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableChatCreate201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChatCreate201Response(val *ChatCreate201Response) *NullableChatCreate201Response {
	return &NullableChatCreate201Response{value: val, isSet: true}
}

func (v NullableChatCreate201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChatCreate201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
