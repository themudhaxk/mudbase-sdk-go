...
// checks if the FunctionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FunctionListResponse{}

// FunctionListResponse Paginated list of functions.
type FunctionListResponse struct {
	Success *bool `json:"success,omitempty"`
	Data *FunctionListResponseData `json:"data,omitempty"`
}
...
func (o *FunctionListResponse) GetData() FunctionListResponseData {
	if o == nil || IsNil(o.Data) {
		var ret FunctionListResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given FunctionListResponseData and assigns it to the Data field.
func (o *FunctionListResponse) SetData(v FunctionListResponseData) {
	o.Data = &v
}

func (o FunctionListResponse) MarshalJSON() ([]byte, error) {
...
func (o FunctionListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFunctionListResponse struct {
	value *FunctionListResponse
	isSet bool
}

func (v NullableFunctionListResponse) Get() *FunctionListResponse {
	return v.value
}

func (v *NullableFunctionListResponse) Set(val *FunctionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFunctionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFunctionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunctionListResponse(val *FunctionListResponse) *NullableFunctionListResponse {
	return &NullableFunctionListResponse{value: val, isSet: true}
}

func (v NullableFunctionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFunctionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
