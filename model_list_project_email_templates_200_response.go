...
// checks if the ListProjectEmailTemplates200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListProjectEmailTemplates200Response{}

// ListProjectEmailTemplates200Response struct for ListProjectEmailTemplates200Response
type ListProjectEmailTemplates200Response struct {
	Success *bool `json:"success,omitempty"`
	Data []EmailTemplateCatalogItem `json:"data,omitempty"`
}
...
func NewListProjectEmailTemplates200Response() *ListProjectEmailTemplates200Response {
	this := ListProjectEmailTemplates200Response{}
	return &this
}
...
func (o *ListProjectEmailTemplates200Response) GetData() []EmailTemplateCatalogItem {
	if o == nil || IsNil(o.Data) {
		var ret []EmailTemplateCatalogItem
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []EmailTemplateCatalogItem and assigns it to the Data field.
func (o *ListProjectEmailTemplates200Response) SetData(v []EmailTemplateCatalogItem) {
	o.Data = v
}

func (o ListProjectEmailTemplates200Response) MarshalJSON() ([]byte, error) {
...
func (o ListProjectEmailTemplates200Response) ToMap() (map[string]interface{}, error) {
...
type NullableListProjectEmailTemplates200Response struct {
	value *ListProjectEmailTemplates200Response
	isSet bool
}

func (v NullableListProjectEmailTemplates200Response) Get() *ListProjectEmailTemplates200Response {
	return v.value
}

func (v *NullableListProjectEmailTemplates200Response) Set(val *ListProjectEmailTemplates200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListProjectEmailTemplates200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListProjectEmailTemplates200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListProjectEmailTemplates200Response(val *ListProjectEmailTemplates200Response) *NullableListProjectEmailTemplates200Response {
	return &NullableListProjectEmailTemplates200Response{value: val, isSet: true}
}

func (v NullableListProjectEmailTemplates200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListProjectEmailTemplates200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
