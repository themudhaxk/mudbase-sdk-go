...
// OrgPlatformDnsVerificationCustomer Additional DNS record from platform staff (manual path), or the first certificate-provisioning TXT shim when automated provisioning is enabled. Prefer `dnsRecords` for full instructions. `staffNote` may appear in admin org detail only.
