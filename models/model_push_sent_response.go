...
// checks if the PushSentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PushSentResponse{}

// PushSentResponse Result of a push send, summarized per channel. `channels.fcm` covers the device-token channel and `channels.webPush` the native Web Push channel; each is `null` when that channel had no targets in the request. 
type PushSentResponse struct {
	Success *bool `json:"success,omitempty"`
	Data *PushSentResponseData `json:"data,omitempty"`
}
...
// SetData gets a reference to the given PushSentResponseData and assigns it to the Data field.
func (o *PushSentResponse) SetData(v PushSentResponseData) {
	o.Data = &v
}

func (o PushSentResponse) MarshalJSON() ([]byte, error) {
...
func (o PushSentResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePushSentResponse struct {
	value *PushSentResponse
	isSet bool
}

func (v NullablePushSentResponse) Get() *PushSentResponse {
	return v.value
}

func (v *NullablePushSentResponse) Set(val *PushSentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePushSentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePushSentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePushSentResponse(val *PushSentResponse) *NullablePushSentResponse {
	return &NullablePushSentResponse{value: val, isSet: true}
}

func (v NullablePushSentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePushSentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
