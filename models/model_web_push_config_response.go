...
// checks if the WebPushConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebPushConfigResponse{}

// WebPushConfigResponse struct for WebPushConfigResponse
type WebPushConfigResponse struct {
	Success *bool `json:"success,omitempty"`
	Data *WebPushConfigResponseData `json:"data,omitempty"`
}
...
func (o *WebPushConfigResponse) GetData() WebPushConfigResponseData {
	if o == nil || IsNil(o.Data) {
		var ret WebPushConfigResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given WebPushConfigResponseData and assigns it to the Data field.
func (o *WebPushConfigResponse) SetData(v WebPushConfigResponseData) {
	o.Data = &v
}

func (o WebPushConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o WebPushConfigResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWebPushConfigResponse struct {
	value *WebPushConfigResponse
	isSet bool
}

func (v NullableWebPushConfigResponse) Get() *WebPushConfigResponse {
	return v.value
}

func (v *NullableWebPushConfigResponse) Set(val *WebPushConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebPushConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebPushConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebPushConfigResponse(val *WebPushConfigResponse) *NullableWebPushConfigResponse {
	return &NullableWebPushConfigResponse{value: val, isSet: true}
}

func (v NullableWebPushConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebPushConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
