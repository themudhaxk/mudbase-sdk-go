...
// checks if the WebPushSubscribeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebPushSubscribeResponse{}

// WebPushSubscribeResponse struct for WebPushSubscribeResponse
type WebPushSubscribeResponse struct {
	Success *bool `json:"success,omitempty"`
	Data *WebPushSubscribeResponseData `json:"data,omitempty"`
}
...
func (o *WebPushSubscribeResponse) GetData() WebPushSubscribeResponseData {
	if o == nil || IsNil(o.Data) {
		var ret WebPushSubscribeResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given WebPushSubscribeResponseData and assigns it to the Data field.
func (o *WebPushSubscribeResponse) SetData(v WebPushSubscribeResponseData) {
	o.Data = &v
}

func (o WebPushSubscribeResponse) MarshalJSON() ([]byte, error) {
...
func (o WebPushSubscribeResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWebPushSubscribeResponse struct {
	value *WebPushSubscribeResponse
	isSet bool
}

func (v NullableWebPushSubscribeResponse) Get() *WebPushSubscribeResponse {
	return v.value
}

func (v *NullableWebPushSubscribeResponse) Set(val *WebPushSubscribeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebPushSubscribeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebPushSubscribeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebPushSubscribeResponse(val *WebPushSubscribeResponse) *NullableWebPushSubscribeResponse {
	return &NullableWebPushSubscribeResponse{value: val, isSet: true}
}

func (v NullableWebPushSubscribeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebPushSubscribeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
