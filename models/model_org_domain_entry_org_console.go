...
// checks if the OrgDomainEntryOrgConsole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgDomainEntryOrgConsole{}

// OrgDomainEntryOrgConsole Org API compact domain row: use **`dnsRecords`** for the Mudbase ownership TXT (purpose `mudbase_ownership`) and routing CNAME. Omits `hostnameNormalized`, `verificationToken`, `dnsTxtHost`, and `dnsTxtValue`. Omits `edge` when edge SSL is not configured. Optional keys with no value are omitted from JSON responses.
type OrgDomainEntryOrgConsole struct {
...
func (o *OrgDomainEntryOrgConsole) SetVerifiedAtNil() {
...
func (o *OrgDomainEntryOrgConsole) SetLastVerifiedAtNil() {
...
func (o *OrgDomainEntryOrgConsole) SetCnameSubmittedAtNil() {
...
func (o *OrgDomainEntryOrgConsole) SetCnameApprovedAtNil() {
...
func (o *OrgDomainEntryOrgConsole) SetCustomDomainVerificationStepNil() {
...
func (o *OrgDomainEntryOrgConsole) SetRoutingCnameTargetNil() {
...
func (o *OrgDomainEntryOrgConsole) SetFlyCertificateStatusNil() {
...
func (o *OrgDomainEntryOrgConsole) SetPlatformDnsVerificationNil() {
...
func (o *OrgDomainEntryOrgConsole) SetPlatformDnsVerificationSubmittedAtNil() {
...
func (o OrgDomainEntryOrgConsole) MarshalJSON() ([]byte, error) {
...
func (o OrgDomainEntryOrgConsole) ToMap() (map[string]interface{}, error) {
...
type NullableOrgDomainEntryOrgConsole struct {
	value *OrgDomainEntryOrgConsole
	isSet bool
}

func (v NullableOrgDomainEntryOrgConsole) Get() *OrgDomainEntryOrgConsole {
	return v.value
}

func (v *NullableOrgDomainEntryOrgConsole) Set(val *OrgDomainEntryOrgConsole) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgDomainEntryOrgConsole) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgDomainEntryOrgConsole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgDomainEntryOrgConsole(val *OrgDomainEntryOrgConsole) *NullableOrgDomainEntryOrgConsole {
	return &NullableOrgDomainEntryOrgConsole{value: val, isSet: true}
}

func (v NullableOrgDomainEntryOrgConsole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgDomainEntryOrgConsole) UnmarshalJSON(src []byte) error {
	v.isSet = true
