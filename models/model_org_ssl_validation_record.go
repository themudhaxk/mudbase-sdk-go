...
// checks if the OrgSslValidationRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgSslValidationRecord{}

// OrgSslValidationRecord struct for OrgSslValidationRecord
type OrgSslValidationRecord struct {
...
func (o *OrgSslValidationRecord) SetTxtNameNil() {
	o.TxtName.Set(nil)
}
...
func (o *OrgSslValidationRecord) SetTxtValueNil() {
	o.TxtValue.Set(nil)
}
...
func (o *OrgSslValidationRecord) SetHttpUrlNil() {
	o.HttpUrl.Set(nil)
}
...
func (o *OrgSslValidationRecord) SetHttpBodyNil() {
	o.HttpBody.Set(nil)
}
...
func (o *OrgSslValidationRecord) SetCnameNil() {
	o.Cname.Set(nil)
}
...
func (o *OrgSslValidationRecord) SetCnameTargetNil() {
...
func (o OrgSslValidationRecord) MarshalJSON() ([]byte, error) {
...
func (o OrgSslValidationRecord) ToMap() (map[string]interface{}, error) {
...
type NullableOrgSslValidationRecord struct {
	value *OrgSslValidationRecord
	isSet bool
}

func (v NullableOrgSslValidationRecord) Get() *OrgSslValidationRecord {
	return v.value
}

func (v *NullableOrgSslValidationRecord) Set(val *OrgSslValidationRecord) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgSslValidationRecord) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgSslValidationRecord) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgSslValidationRecord(val *OrgSslValidationRecord) *NullableOrgSslValidationRecord {
	return &NullableOrgSslValidationRecord{value: val, isSet: true}
}

func (v NullableOrgSslValidationRecord) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgSslValidationRecord) UnmarshalJSON(src []byte) error {
	v.isSet = true
