...
type WalletTransaction struct {
	...
	TokenTransfers []WalletTransactionTokenTransfersInner `json:"tokenTransfers,omitempty"`
}
...
func (o *WalletTransaction) GetTokenTransfers() []WalletTransactionTokenTransfersInner {
	if o == nil || IsNil(o.TokenTransfers) {
		var ret []WalletTransactionTokenTransfersInner
		return ret
	}
...
// SetTokenTransfers gets a reference to the given []WalletTransactionTokenTransfersInner and assigns it to the TokenTransfers field.
...
func (o WalletTransaction) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TokenTransfers) {
		toSerialize["tokenTransfers"] = o.TokenTransfers
	}
