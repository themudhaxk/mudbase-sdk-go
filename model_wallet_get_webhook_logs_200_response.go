...
// checks if the WalletGetWebhookLogs200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletGetWebhookLogs200Response{}

// WalletGetWebhookLogs200Response struct for WalletGetWebhookLogs200Response
type WalletGetWebhookLogs200Response struct {
...
func NewWalletGetWebhookLogs200Response() *WalletGetWebhookLogs200Response {
	this := WalletGetWebhookLogs200Response{}
	return &this
}
...
func (o WalletGetWebhookLogs200Response) MarshalJSON() ([]byte, error) {
...
func (o WalletGetWebhookLogs200Response) ToMap() (map[string]interface{}, error) {
...
type NullableWalletGetWebhookLogs200Response struct {
	value *WalletGetWebhookLogs200Response
	isSet bool
}

func (v NullableWalletGetWebhookLogs200Response) Get() *WalletGetWebhookLogs200Response {
	return v.value
}

func (v *NullableWalletGetWebhookLogs200Response) Set(val *WalletGetWebhookLogs200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletGetWebhookLogs200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletGetWebhookLogs200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletGetWebhookLogs200Response(val *WalletGetWebhookLogs200Response) *NullableWalletGetWebhookLogs200Response {
	return &NullableWalletGetWebhookLogs200Response{value: val, isSet: true}
}

func (v NullableWalletGetWebhookLogs200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletGetWebhookLogs200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
