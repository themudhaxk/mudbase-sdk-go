...
// checks if the EditMessage200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditMessage200Response{}

// EditMessage200Response struct for EditMessage200Response
type EditMessage200Response struct {
	Success *bool `json:"success,omitempty"`
	Data *EditMessage200ResponseData `json:"data,omitempty"`
}
...
func (o *EditMessage200Response) GetData() EditMessage200ResponseData {
	if o == nil || IsNil(o.Data) {
		var ret EditMessage200ResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given EditMessage200ResponseData and assigns it to the Data field.
func (o *EditMessage200Response) SetData(v EditMessage200ResponseData) {
	o.Data = &v
}

func (o EditMessage200Response) MarshalJSON() ([]byte, error) {
...
func (o EditMessage200Response) ToMap() (map[string]interface{}, error) {
...
type NullableEditMessage200Response struct {
	value *EditMessage200Response
	isSet bool
}

func (v NullableEditMessage200Response) Get() *EditMessage200Response {
	return v.value
}

func (v *NullableEditMessage200Response) Set(val *EditMessage200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEditMessage200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEditMessage200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditMessage200Response(val *EditMessage200Response) *NullableEditMessage200Response {
	return &NullableEditMessage200Response{value: val, isSet: true}
}

func (v NullableEditMessage200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditMessage200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
