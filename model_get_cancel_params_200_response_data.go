...
// checks if the GetCancelParams200ResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCancelParams200ResponseData{}

// GetCancelParams200ResponseData struct for GetCancelParams200ResponseData
type GetCancelParams200ResponseData struct {
...
func NewGetCancelParams200ResponseData() *GetCancelParams200ResponseData {
	this := GetCancelParams200ResponseData{}
	return &this
}
...
func (o GetCancelParams200ResponseData) MarshalJSON() ([]byte, error) {
...
func (o GetCancelParams200ResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableGetCancelParams200ResponseData struct {
	value *GetCancelParams200ResponseData
	isSet bool
}

func (v NullableGetCancelParams200ResponseData) Get() *GetCancelParams200ResponseData {
	return v.value
}

func (v *NullableGetCancelParams200ResponseData) Set(val *GetCancelParams200ResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCancelParams200ResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCancelParams200ResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCancelParams200ResponseData(val *GetCancelParams200ResponseData) *NullableGetCancelParams200ResponseData {
	return &NullableGetCancelParams200ResponseData{value: val, isSet: true}
}

func (v NullableGetCancelParams200ResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCancelParams200ResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
